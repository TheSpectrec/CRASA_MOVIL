...
const Sales = () => {
  ...
  return (
    <Animated.ScrollView style={styles.container} onScroll={scrollHandler} scrollEventThrottle={16}>
        ...
        <View style={styles.filtersGrid}>
          ...
          <View style={styles.filterColumn}>
            ...
            <View style={styles.filterItem}>
              ...
              <TouchableOpacity style={styles.filterButton} onPress={() => openModal("seller", "Vendedor")}>
                <Text style={styles.filterButtonText}>{getSelectedText("seller")}</Text>
                <View style={styles.filterButtonRight}>
                  {filters.sellers.length > 0 && (
                    <View style={styles.filterBadge}>
                      <Text style={styles.filterBadgeText}>{filters.sellers.length}</Text>
                    </View>
                  )}
                  <ChevronDown size={16} color="#666" />
                </View>
      ...
      {renderFilterModal("seller", "Vendedor")}
    </Animated.ScrollView>
  )
}
